...
CREATE TABLE `language_index_factors` (
  `Page_Count-Factor` float NOT NULL,
  `Word_Count-Factor` float NOT NULL,
  `Lang_Reach-Factor` float NOT NULL,
  `Lang_local-Factor` float NOT NULL,
  `Aff_Support-Factor` float NOT NULL
...
INSERT INTO `language_index_factors` VALUES (0.3,0.2,0.3,0.1,0.1);
...
-- Dump completed on 2021-03-02 22:44:40
